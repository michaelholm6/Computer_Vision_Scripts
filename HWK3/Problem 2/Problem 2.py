...
min_size = 400
max_size = 450
"""removing islands outside of correct range"""
...
"""dilating dice to make sure structuring elements fit"""
numbers = ['6', '5', '4', '3', '2', '1']
for number in numbers:
    """reading in structuring element"""
    ...
    """scaling to make it the correct size for the image"""
    ...
    """writing numbers in correct location"""
...
plt.savefig('p2_image3_answer.png')
plt.show()
